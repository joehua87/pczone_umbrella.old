defmodule Pczone.Barebones do
  require Logger
  import Ecto.Query, only: [where: 2, from: 2]
  import Dew.FilterParser
  alias Pczone.{Repo, Barebone}
  ...
  def create(%{
    ...
    Ecto.Multi.new()
    |> Ecto.Multi.insert(:motherboard, Pczone.Motherboard.new_changeset(motherboard))
    |> Ecto.Multi.insert(:chassis, Pczone.Chassis.new_changeset(chassis))
    |> Ecto.Multi.insert(:psu, Pczone.Psu.new_changeset(psu))
    |> Ecto.Multi.run(
      :barebone,
      fn _,
         %{
