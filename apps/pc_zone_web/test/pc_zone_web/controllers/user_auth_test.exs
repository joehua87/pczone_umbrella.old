defmodule PcZoneWeb.UserAuthTest do
  use PcZoneWeb.ConnCase, async: true

  alias PcZone.Users
  alias PcZoneWeb.UserAuth
  import PcZone.UsersFixtures

  @remember_me_cookie "_pc_zone_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PcZoneWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PcZoneWeb.Endpoint.subscribe(live_socket_id)
